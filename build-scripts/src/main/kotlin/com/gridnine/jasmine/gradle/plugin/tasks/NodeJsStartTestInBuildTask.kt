...
abstract class NodeJsStartTestInBuildTask : NodeTask {
    ...
    constructor(launcherName:String, pluginId:String){
        ...
        args.set(arrayListOf("--timeout", "10000", "--reporter", "mocha-jenkins-reporter", "--reporter-option", "junit_report_name=Tests,junit_report_path=build/junit-reports/${pluginId}-junit.xml,junit_report_stack=1", "node_modules/$launcherName"))
    }
    companion object{

...
class TableLayoutDescriptionDTJS():com.gridnine.jasmine.server.standard.model.rest.BaseLayoutDescriptionDTJS(){

    var expandLastRow:Boolean?=null

    val columns = arrayListOf<com.gridnine.jasmine.server.standard.model.rest.TableColumnDescriptionDTJS>()

...
class TablePanel : ZkServerUiTable(createConfiguration()){
    ...
    private fun addTestRow() {
        ...
        firstRowComponents.add(ServerUiTableCell(textBox, 2))
    ...
    companion object{
        private fun createConfiguration(): ServerUiTableConfiguration {
            ...
            result.width = "100%"
            result.columns.add(ServerUiTableColumnDescription("Поле 1", 100))
            result.columns.add(ServerUiTableColumnDescription("Поле 2", 100))
            result.columns.add(ServerUiTableColumnDescription(null, 50))
            return result
        }
    }
}

...
import com.gridnine.jasmine.server.core.ui.components.SelectConfiguration
...
class ZkSelect(configure: SelectConfiguration.() -> Unit) : Select, ZkUiComponent{
    ...
    private val config = SelectConfiguration()
    init {
        config.configure()
    }
    ...
    override fun getZkComponent(): HtmlBasedComponent {
        ...
        component!!.configuration.dataSourceType  = if(config.mode == SelectDataType.REMOTE) Select2DataSourceType.REMOTE else Select2DataSourceType.LOCAL

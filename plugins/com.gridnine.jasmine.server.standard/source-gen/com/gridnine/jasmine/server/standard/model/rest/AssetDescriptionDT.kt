...
class AssetDescriptionDT():com.gridnine.jasmine.server.core.model.rest.BaseRestEntity(){

    var displaName:String?=null

    var id:String?=null

    val properties = arrayListOf<com.gridnine.jasmine.server.standard.model.rest.IndexPropertyDescriptionDT>()

    val collections = arrayListOf<com.gridnine.jasmine.server.standard.model.rest.IndexCollectionDescriptionDT>()

...
class SandboxComplexDocumentGeneralTileFullVM():com.gridnine.jasmine.server.core.model.ui.BaseVMEntity(){
    ...
    var entityProperty:com.gridnine.jasmine.server.core.model.domain.EntityReference<com.gridnine.jasmine.server.sandbox.model.domain.SandboxUserAccount>?=null
    ...
    val entityCollection = arrayListOf<com.gridnine.jasmine.server.sandbox.model.ui.SandboxTableVM>()
    ...
    override fun setValue(propertyName:String, value:Any?){
        ...
        if("entityProperty" == propertyName){
            this.entityProperty=value as com.gridnine.jasmine.server.core.model.domain.EntityReference<com.gridnine.jasmine.server.sandbox.model.domain.SandboxUserAccount>?
            return
        }

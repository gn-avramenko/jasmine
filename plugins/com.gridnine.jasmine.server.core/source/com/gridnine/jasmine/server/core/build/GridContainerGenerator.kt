                ...
                "_node = ${UiLibraryAdapter::class.qualifiedName}.get().createGridLayoutContainer"{
                    ...
                    columns.forEach { column ->
                        when(column.predefinedWidth){
                            PredefinedColumnWidth.STANDARD ->  """columns.add(${GridLayoutColumnConfiguration::class.qualifiedName}("300px"))"""()
                            PredefinedColumnWidth.REMAINING ->  """columns.add(${GridLayoutColumnConfiguration::class.qualifiedName}("100%"))"""()
                            PredefinedColumnWidth.CUSTOM ->  """columns.add(${GridLayoutColumnConfiguration::class.qualifiedName}("${column.customWidth}"))"""()
                        }
                    }
                }
